...
if (isMobileDevice()) {
  ...
  // ?mock=rp2350&fw=115 boots the mock as the released 1.1.5 device (wire V20 --
  // the full leveller-mask + ADAT + loudness/crossfeed-mask surface; default is
  // V10 / 1.1.4).
  ...
  const mockOpts = {
    ...(want115 ? { wireVersion: 20, fwVersion: { major: 1, minor: 1, patch: 5 } } : {}),

...
export const LATEST_CHANGES = {
  ...
  highlights: [
    ...
    'Also in this release line: the SY.16 pin map with pop-up pin pickers showing who holds each GPIO, and a decluttered SYSTEM tab that moves telemetry, error counters, and buffer stats behind the DEBUG toggle',
